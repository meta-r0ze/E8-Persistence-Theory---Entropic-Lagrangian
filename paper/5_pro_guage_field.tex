...
Furthermore, as established in \cref{sec:unitary_flux_constraint}, the kinematic bandwidth limit fixes the spatial hopping amplitude $w=1/2$, which directly corresponds to the gauge coupling coefficient $g=1/2$ in the continuum limit, leaving no free tuning parameters.
