...
\textbf{Conclusion.} This derivation suggests an interpretation of General Relativity as the emergent regulatory mechanics of the bulk lattice. The Einstein-Hilbert action effectively describes the entropic cost of updating the metric to preserve causal order (the Toll) and maintaining the spacetime container itself against entropic dissolution (the Margin).
